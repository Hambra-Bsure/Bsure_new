...
class OtherAssetScreen extends StatefulWidget {
  final String assetType;

  const OtherAssetScreen({Key? key, required this.assetType}) : super(key: key);

  @override
  _OtherAssetScreenState createState() => _OtherAssetScreenState();
}

class _OtherAssetScreenState extends State<OtherAssetScreen> {
