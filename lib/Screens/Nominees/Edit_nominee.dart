...
class _NomineeEditScreenState extends State<NomineeEditScreen> {
  ...
  void initState() {
    super.initState();
    _firstNameController = TextEditingController(text: widget.nominee.firstName ?? '');
    _lastNameController = TextEditingController(text: widget.nominee.lastName ?? '');
    _mobileNumberController = TextEditingController(text: widget.nominee.mobileNumber ?? '');
    _relationController = TextEditingController(text: widget.nominee.relation ?? '');
    _emailController = TextEditingController(text: widget.nominee.email ?? '');
    _ageController = TextEditingController(text: widget.nominee.age?.toString() ?? '');
    _guardianNameController = TextEditingController(text: widget.nominee.guardianName ?? '');
    _guardianMobileNumberController = TextEditingController(text: widget.nominee.guardianMobileNumber ?? '');
    _addressController = TextEditingController(text: widget.nominee.address ?? '');
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Enter Nominee Age'),
                ...
                child: Column(
                  children: [
                    TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: 'Enter Guardian Name'),
                      validator: (value) {
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: 'Enter Guardian Mobile No'),
                      keyboardType: TextInputType.number,
                      inputFormatters: [
                      ...
                      validator: (value) {
                        if (isGuardianVisible && (value == null || value.length != 10)) {
